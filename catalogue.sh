...
echo -e "\e[36m >>>>>>>>>>>>>Create mongodb repofile<<<<<<<<<<<<<<< \e[0m" | tee -a /tmp/roboshop.log
cp mongo-repofile /etc/yum.repos.d/mongo.repo &>> /tmp/roboshop.log

echo -e "\e[36m >>>>>>>>>>>>>Download and install nodejs repos<<<<<<<<<<<<<<< \e[0m" | tee -a /tmp/roboshop.log
curl -sL https://rpm.nodesource.com/setup_lts.x | bash &>> /tmp/roboshop.log

echo -e "\e[36m >>>>>>>>>>>>>install nodejs<<<<<<<<<<<<<<< \e[0m" | tee -a /tmp/roboshop.log
yum install nodejs -y &>> /tmp/roboshop.log

echo -e "\e[36m >>>>>>>>>>>>>Create a user for roboshop<<<<<<<<<<<<<<< \e[0m" | tee -a /tmp/roboshop.log
...
echo -e "\e[36m >>>>>>>>>>>>>Change directory to app<<<<<<<<<<<<<<< \e[0m" | tee -a /tmp/roboshop.log
cd /app &>> /tmp/roboshop.log

echo -e "\e[36m >>>>>>>>>>>>>Extract the application content<<<<<<<<<<<<<<< \e[0m" | tee -a /tmp/roboshop.log
...
echo -e "\e[36m >>>>>>>>>>>>>Daemon reload and restart service<<<<<<<<<<<<<<< \e[0m" | tee -a /tmp/roboshop.log
